---
title: "Introduction to Business Journalism Research"
output:  
  html_document:
      toc: true
      toc_float: true
...
<br>  
<img src="Images/NPF logo.jpeg" width="175" height="100" />    
<br>  
...
<img src="Images/UARK2.jpg" width="300" height="50" />
...
> [Speadsheet with PPP Recipients $150k and Above](https://data.sba.gov/dataset/8aa276e2-6cab-4f86-aca4-a7dde42adf24/resource/6b62a44b-69ec-436a-9b95-0ea550475543/download/public_150k_plus.csv){target="_blank"}
...
<img src="Images/SEC.png" width="600" height="100" />
...
**Example: INUVO, INC**     
  ...
  + Details from:       
> [PPP Recipients $150k and Above](https://data.sba.gov/dataset/8aa276e2-6cab-4f86-aca4-a7dde42adf24/resource/6b62a44b-69ec-436a-9b95-0ea550475543/download/public_150k_plus.csv){target="_blank"}
...
+ Jan. 31, 2021: 71 full-time employees      
...
>**More from Inuvo 10-K**     
  + "Beginning in late April 2020, we experienced a significant reduction in demand (marketing budgets) within the ValidClick platform and a modest decline in demand within the IntentKey platform, the combination of which has resulted in a significant reduction in our revenue run rate."      
  + "We experienced less advertising demand from the travel, leisure and hospitality verticals."      
  + Reliant upon Yahoo! and Google for most of our revenue. During 2020 they accounted for 33.3%, and 27.2% of our revenues, respectively. In 2019, Yahoo! and Google accounted for 64.4% and 14.1% of our revenues, respectively.       
...
>**And Still More from Inuvo 10-K **   
  ...
  + For the year ended December 31, 2020, net loss $7.3 million versus a net loss of $4.5 million in year earlier.   

**Red Flags & High Points**    
  ...
  3) *Inuvo lost $7.3 million in 2019*
  4) *Managed to avoid nosedive: Prior Year's 10-K said "Our auditors have raised substantial doubts as to our ability to continue as a going concern... We have sustained recurring losses from operations and have a net capital deficiency."*
  5) *Improved their capital cushion, expanded workforce, paid off PPP loan.*
  

> **Takeaways**:   
  + Small company fighting successfully to stay in business
  + Raised nearly $31 million through securities sales
  + Paid off PPP loan
  + Debt Load Shrinking: Net Interest Expense Declining 
  + Expense Declining    
...
<img src="Images/Penguin.png" width="400" height="200" />    
...
### Industry Research: NAICS Codes
  ...
  > [Search North American Industry Classification System (NAICS) "CNTL" + click for a New Tab](https://www.census.gov/naics/){target="_blank"}
  > NAICS is federal standard for classifying businesses, organizing U.S. economic data

### Investigative Reporting on Businesses    

  > [Reynolds Center Introduction to Investigating Businesses "CNTL" + click for a New Tab](https://businessjournalism.org/2020/07/investigative-reporting-on-business/){target="_blank"}
...
Search Engines for People, Businesses   
  ...
  Nuwber     
  <https://nuwber.com/>   
  Pipl - $300 per year subscription  
  <http://www.pipl.com/>    
