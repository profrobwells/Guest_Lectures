...
**Chunks: The gray boxes have live R code. Click the green arrow at the right on line 55 and run the demo() command**
```{r}
demo()
```
...
#### Install software to grab data
    ...
    Rio package: easy importing features 
    Janitor package: data cleaning
<br> 
**At Home:**    
