...
**Chunks: The gray boxes have live R code. Click the green arrow at the right on line 55 and run the help.start() command**
```{r}
help.start()
```
<br> 
...
Context:
NYT earnings in 2020 = $100 m
Facebook profit for one day: $114 million (Q42021=$10.3B)
...
Mac. https://mirrors.nics.utk.edu/cran/bin/macosx/R-4.0.2.pkg

Windows https://mirrors.nics.utk.edu/cran/

Accept all of the default settings. 

2) Install RStudio. This is the graphical interface we use to manage and create R code. Download the open source edition of R Studio desktop and follow the prompts to install it.
...
Here's a good overview of the program: https://docs.google.com/presentation/d/1O0eFLypJLP-PAC63Ghq2QURAnhFo6Dxc7nGt4y_l90s/edit#slide=id.p
