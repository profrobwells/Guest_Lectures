...
With this notebook, we will take separate text files and compile them into a single dataframe for analysis.


Many thanks to the famous **Sean Mussenden** for getting me started with this project.
